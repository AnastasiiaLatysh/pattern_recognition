...
model.add(Dense(units=512, activation=tf.nn.relu, use_bias=True, name='Dense-Relu1'))

# Layer2 is a dense layer
model.add(Dense(units=128, activation=tf.nn.relu, use_bias=True, name='Dense-Relu2'))
